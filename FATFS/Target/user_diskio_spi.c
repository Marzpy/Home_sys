...
/*
//
// Original solution as in STM32 Course - CLK prescaler set not correctly
//
#define FCLK_SLOW() { hspi3.Instance->I2SPR = 256; }	// Set SCLK = slow
#define FCLK_FAST() { hspi3.Instance->I2SPR = 2; }		// Set SCLK = fast
*/
...
#define FCLK_SLOW() { MODIFY_REG(hspi3.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_256); }	/* Set SCLK = slow, approx 280 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(hspi3.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_2); }	/* Set SCLK = fast, approx 4.5 MBits/s */
